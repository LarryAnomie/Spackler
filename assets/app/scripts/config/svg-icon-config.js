...
define([
    ...
    var svgPath = '/wp-content/themes/spackler/assets/app/i/svg/';

    var svgIconConfig = {
        clock: {
            url: svgPath + 'clock.svg',
            animation: [{
                el: 'path:nth-child(2)',
                animProperties: {
                    from: {
        ...
        hamburger: {
            //url: '/wp-content/themes/larry/assets/svg/hamburger.svg',
        ...
        navLeftArrow: {
            url: svgPath + 'nav-left-arrow.svg',
            animation: [{
                el: 'path',
                animProperties: {
                    from: {

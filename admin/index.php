...
$theme_metaboxes = array(
        ...
        "project-1" => array (
            "name"      => "project-1",
            "default"   => "",
            "label"     => "1st Project Image",
            "type"      => "text",
            "desc"      => "Upload your image with 'Add Media' above post window, copy the url and paste it here. Height and width should be: 583x362 pixels"
        ),
        "project-2" => array (
            "name"      => "project-2",
            "default"   => "",
            "label"     => "2nd Project Image",
            "type"      => "text",
            "desc"      => "Upload your image with 'Add Media' above post window, copy the url and paste it here. Height and width should be: 583x362 pixels"
